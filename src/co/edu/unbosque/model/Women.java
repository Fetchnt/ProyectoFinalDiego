...
/**
 * Clase que representa a un usuario de tipo mujer en el sistema. <b>pre:</b>
 * Debe existir un usuario con datos válidos. <br>
 * <b>post:</b> Crea o gestiona la información del usuario femenino.
 * 
 */
public class Women extends User implements Serializable {
	...
	/**
	 * Retorna una representación en texto del objeto {@code Women}.
	 * 
